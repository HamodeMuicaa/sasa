...
stopuser = {}
# إعدادات الاتصال
CHANNEL_ID_DAY = -1002383889056
CHANNEL_INVITE_LINK_DAY = 'https://t.me/+rb55tDHd2VI4YWM0'

CHANNEL_ID_WEEK = -1002383889056
CHANNEL_INVITE_LINK_WEEK = 'https://t.me/+nknG0oBRZRJhOGQ0'

CHANNEL_ID_MONTH = -1002383889056
CHANNEL_INVITE_LINK_MONTH = 'https://t.me/+juDwf55A3qpjOGI0'

bot_token = '7853719064:AAHvjSrQcjHwejj1nrWX-hK807K7W1fYHog'
admin_id = 7069250607
admin = admin_id
api_id = '26172012'  # يجب استبداله بالمعرف API الخاص بك
api_hash = '8bc6104d34644403e819064cd4d1ad98'  # يجب استبداله بالهاش API الخاص بك
phone_number = '+9647863522650'  # حط رقم موبايلك مع كود الدوله
cache_file = "bin_cache.json"
bot_working = True
banned_users = set()
admins = set([7069250607])#ايديك هنا بدل كلمه id
users = {}
...
def my_function(message):
    if message.chat.type == "private":
        ...
        if BL == 'FREE':
            ...
            contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/IV2VV")
            keyboard.add(contact_button)
            random_number = random.randint(33, 82)
            photo_url = f'https://t.me/on_ng/20383'
...
''', reply_markup=keyboard)
            return
        keyboard = types.InlineKeyboardMarkup()
        contact_button = types.InlineKeyboardButton(text=f"✨ JOIN✨", url="https://t.me/SSAAV13")
        keyboard.add(contact_button)
...
def brn(ccx):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..wISh_RkIXgTpJr7C45m61Nx4sINH-5_WqfKvvaMSdMbhGy9RiOOcoe65mD7_lcm31C7WSTh9jAwITAJXOlOf0A',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'custom',
        'sessionId': 'd7ad57fc-e4fd-4025-8427-b4d7c585e3ab',
    },
    ...
    'additionalInfo': {
        'ipAddress': '45.94.210.236',
        'billingPhoneNumber': '812096325145',
        'billingGivenName': 'ali',
        'billingSurname': 'ali',
        'email': 'hmdhmadh585@gmail.com',
    },
    'bin': '557501',
    'dfReferenceId': '0_df7a62c8-e25c-4c2f-b546-e9af3117b596',
    'clientMetadata': {
        'requestedThreeDSecureVersion': '2',
        'sdkVersion': 'web/3.103.0',
        'cardinalDeviceDataCollectionTimeElapsed': 4348,
        'issuerDeviceDataCollectionTimeElapsed': 2595,
...
def respond_to_vbv(message):
	def my_function():
		...
		try:
			...
			msg=f'''<b>𓆩𝗞𝗲𝘆 𝗥𝗲𝗱𝗲𝗲𝗺𝗲𝗱 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆𓆪! 👑🌪:  𝐃ev : 『@IV2VV』  »»{timer}
{typ}</b>'''
...
def start(message):
	def my_function():
		...
		try:
			...
			pas ='OTPHMD-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))
			current_time = datetime.now()
...
def stop_operation(call):
    """Stop the ongoing operation."""
    global is_checking
    is_checking = False
    try:
        current_message = call.message.text
        new_message = "✅ تم انهاء العمليه بنجاح ✅"

        if current_message != new_message:
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text=new_message, parse_mode="HTML")
    except apihelper.ApiTelegramException as e:
        logging.error(f"Error stopping operation: {str(e)}")
        bot.answer_callback_query(call.id, "حدث خطأ أثناء محاولة إيقاف العملية. حاول مرة أخرى.")
...
●●●●●●●●●●●"""
            ...
            with open('Saoud_Scrap.txt', 'rb') as file:
                ...
                dev_button = telebot.types.InlineKeyboardButton(text="𝗗𝗘𝗩", url='https://t.me/IV2VV')
